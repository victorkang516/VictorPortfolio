  ...
  return (
    <div className="pf">
      ...
      <section className="portfolio-intro" id="portfolio-intro">
        <h2>
          Final Year Project | Software Development | Mobile App | AR App |
          Unity
        </h2>
        <h3>
          ...
          is made using Unity Engine, with other technologies like ARFoundation,
          Unity Photon Pun 2, Firebase.
        </h3>

        <div className="portfolio__link">
          <a
            className="portfollio__button"
      ...
      <section className="content">
        ...
        <p>
          ...
          are required to place 3d model (house model) on a table or floor, then
          adjust the position, rotation and size of the 3D model.{" "}
        </p>

        <img
          src="../img/idar/idar_ar.gif"
          alt="idar ar 1"
          className="portfolio__image"
        ></img>
        ...
        <p>
          ...
          <strong>move, rotate and change the furniture model type</strong>. For
          floor and paint, user can only change its colour/texture.
        </p>

        <img
          src="../img/idar/idar_ar2.gif"
          alt="idar ar 2"
          className="portfolio__image"
        ></img>
        ...
        <img
          src="../img/idar/idar_ar3.png"
          alt="idar ar 3"
          className="portfolio__image"
        ></img>

        <p>
          Lastly, user can save the room session, and continue the room session
          next time.
        </p>
      </section>
      ...
      <section id="demo-video" className="content">
        ...
        <Iframe
          ...
          width="1080"
          height="720"
          url="https://www.youtube.com/embed/VBUnJYVM1rM"
        ></Iframe>
      </section>
